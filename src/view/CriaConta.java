...
public class CriaConta extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(fotoUs)
                    .addComponent(confirmaSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(146, 146, 146))
    ...
    private void criarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_criarMousePressed
        ...
        if(new String(senha.getPassword()).equals(new String(confirmaSenha.getPassword()))){
            Usuario u = new Usuario();
            CadastroDao dao = new CadastroDao();

            u.setNome_usuario(name.getText());
            u.setEmail_usuario(email.getText());
            u.setSenha_usuario(senha.getText());
    ...
    private void confirmaSenhaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_confirmaSenhaKeyPressed
        // TODO add your handling code here:
        if(evt.getKeyCode()== evt.VK_ENTER){
            criar.requestFocus();
        }
    }//GEN-LAST:event_confirmaSenhaKeyPressed
